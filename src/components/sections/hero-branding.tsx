...
const HeroBranding = () => {
  return (
    ...
    <div className="relative z-10 max-w-[512px] mx-auto px-4 pt-0 pb-0 text-center -mt-6">
      ...
      {/* Gift Card Visual */}
      <div 
        className="relative mb-1 -mt-4 group cursor-pointer" 
      ...
      >
        <div className="relative inline-block animate-float will-change-transform">
          ...
          <div className="relative z-10 w-[240px] sm:w-[320px] mx-auto transition-transform duration-500 group-hover:scale-105">
            <img 
              src="https://i.imgur.com/oArRdgF.png" 
              alt="Sam's Club $500 Gift Card" 
      ...
      <div className="flex flex-col items-center gap-0.5 px-2">
        <div className="relative">
          <h1 className="text-[21px] md:text-[27px] font-extrabold leading-tight tracking-tight flex items-center justify-center gap-x-2 flex-wrap font-poppins">
            ...
            <span className="text-[#0a6cff]">Sam's Club Rewards</span>
            <div className="flex items-center -ml-1">
              <Gift className="w-6 h-6 text-[#0a6cff] fill-transparent" />
            </div>
          </h1>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 w-full text-center">
          <Sparkles className="w-3.5 h-3.5 text-[#0a6cff] shrink-0 animate-sparkle" />
          <p className="text-[13px] sm:text-sm md:text-[15px] text-[#182C54]/90 font-medium leading-relaxed whitespace-nowrap font-poppins">
            Here&apos;s how to claim your <span className="text-[#0a6cff] font-bold">$500 gift card</span>
          </p>
          <Sparkles className="w-3.5 h-3.5 text-[#0a6cff] shrink-0 animate-sparkle" />
        </div>
      </div>
