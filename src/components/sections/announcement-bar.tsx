...
const AnnouncementBar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-[#001f69] border-b border-[#001f69]/30 py-1.5 px-4 shadow-[0_4px_20px_rgba(0,0,0,0.3)] backdrop-blur-md">
        ...
        <div className="flex items-center justify-center gap-3">
            <div className="flex items-center justify-center gap-2 text-center">
              ...
              <p className="text-white text-[12px] font-bold tracking-tight text-center">
                ...
                minutes left to unlock your Lowe's reward
              </p>
            </div>
        </div>
      ...
      <div className="absolute bottom-0 left-0 h-[2px] bg-gradient-to-r from-transparent via-[#001f69] to-transparent w-full opacity-50 overflow-hidden">
